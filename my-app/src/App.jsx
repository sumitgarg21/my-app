  ...
  return (
    <div>
      ...
      >
        ...
        <button
          style={{ backgroundColor: "black", marginLeft: "12rem" }}
          type="submit"
        >
            ...
            {responseData.predictions.map((prediction, index) => (
              <div
                ...
                style={{
                  ...
                  left: `${
                    (prediction.x / responseData.image.width) * 800 - 15
                  }px`,
                  top: `${
                    (prediction.y / responseData.image.height) * 600 - 15
                  }px`,
                  width: `${
                    (prediction.width / responseData.image.width) * 1200
                  }px`,
                  height: `${
                    (prediction.height / responseData.image.height) * 800
                  }px`,
